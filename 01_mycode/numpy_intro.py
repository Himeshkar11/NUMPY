...
print("The randomas numbers are very useful to test the experiments or simulations ")
# rng we use this variable to create an object of random number 
rng = np.random.default_rng()
print(f"the integers generated from the given range is {rng.integers(1,7)}")
print(f"the integers generated from the given range is {rng.integers(low =1,high=7)}")
print(f"the integers generated from the given range is {rng.integers(low =1,high=7,size =3)} will generate 3 random numbers in a 1d array ")
print(f"the integers generated from the given range is {rng.integers(low =1,high=7,size =(3,2))} will generate 3 rows and 2 columns random numbers in a 2d array  ")
print(f"fixing the seed seed is a function which fixes the randomness")
rngnew = np.random.default_rng(seed = 1)
print(f"the integers generated from the given range is {rngnew.integers(1,7)}")
print(f"the integers generated from the given range is {rngnew.integers(low =1,high=7)}")
print(f"the integers generated from the given range is {rngnew.integers(low =1,high=7,size =3)} will generate 3 random numbers in a 1d array ")
print(f"the integers generated from the given range is {rngnew.integers(low =1,high=7,size =(3,2))} will generate 3 rows and 2 columns random numbers in a 2d array  ")    
print("the random floats generated are as follows ")
print(np.random.uniform(low=1,high=101,size=(3)))
print(np.random.uniform(low=1,high=101,size=(3,2)))
print("shifting an array")
print("This can be done using the shuffle method of the numpy")
arrshuffle = np.array([1,2,3,4,5])
print(f"the shuffled array is : {rng.shuffle(arrshuffle)}")
print("The choice function : this can be used to select a certain item from the items ")
fruits = np.array(["🍎","🍍","🍌","🍇","🍉"])
print(rng.choice(fruits))
print(rng.choice(fruits,size = 3))
print(rng.choice(fruits,size =(3,2)))
print("The numpy course by bro code is completed ")